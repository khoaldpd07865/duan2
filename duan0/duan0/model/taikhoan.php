 ...
 function goimail($to,$Pass){ 
    ...
    $mail = new PHPMailer\PHPMailer\PHPMailer(true);  //true: enables exceptions
      try {
          ...
          $nguoigui = 'leduy.khoa456789@gmail.com';
          $matkhau = 'txbc jrmy qgeb agrc';
      $tennguoigui = 'Admin';
        ...
        //   $to = "nhập email của người nhận";
          ...
          $noidungthu = "<h3 style='display: inline-block'>Mật khẩu của bạn là: </h3>"."$Pass" ;
