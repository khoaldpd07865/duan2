              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action="index.php?action=dangki" method="post">
                  ...
                  <label class="form-label" for="form2Example17">Xác Nhận Mật Khẩu</label>
                    ...
                    <input type="password"  name="confirm-pass"  id="form2Example17" class="form-control form-control-lg" />
                  </div>
                  <div class="form-outline mb-4">
                  ...
                  <button type="submit" name="submit"  class="btn btn-primary">Đăng Ký</button>
                    <?php if(isset($messageFromPHPb)){echo  $messageFromPHP;} ?>
                  </div>

                  <a class="small text-muted" href="index.php?action=quenmk">Forgot password?</a>
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="index.php?action=login"
